...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        @if (auth()->user()->role == 'admin')
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="klik untuk menambah pertanyaan">
                <a href="{{ route('question.create') }}" class="btn btn-light-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @if (auth()->user()->role == 'admin')
                                <a href="{{ route('question.edit',['question'=>$question]) }}" class=" btn btn-light-success btn-sm">Ubah</a>
                                <form  method="post" class="d-inline" onsubmit="btnDelete('question',{{ $question->id }})">
                                    @csrf
                                    @method('delete')
                                    <button class="btn btn-light-danger btn-sm" >Hapus</button>
                                </form>
                            @endif
                            @include('admin.question.show')
                        </td>
                    </tr>
