<div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        ...
        <a href="../../demo1/dist/index.html">
            <img alt="Logo" src="{{ asset('images/navbar-logo-transparent-white.png') }}" class="h-60px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->segment(2) == 'user' ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->segment(2) == 'service' ? 'active' : '' }}"
                        ...
                        <span class="menu-title">Unsur Pelayanan</span>
                    </a>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->segment(2) == 'period' ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <div class="menu-content pb-2">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Laporan Survey</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link {{ request()->segment(2) == 'respondent' ? 'active' : '' }}"
                        href="{{ route('report.respondent') }}">
                        <span class="menu-icon">
                    ...
                    <a class="menu-link {{ request()->segment(2) == 'ikm' ? 'active' : '' }}"
                        ...
                        <span class="menu-title">IKM</span>
                    </a>
                </div>
                <div class="menu-item">
                    <div class="menu-content">
