        ...
        <div class="col-6">
            ...
            <div class="card  mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5 justify-content-end">
                    <div class="card-toolbar float-right" data-bs-toggle="tooltip" data-bs-placement="top"
                        data-bs-trigger="hover" title="klik untuk mengubah profil">
                        <a href="{{ route('profile.edit', ['user' => auth()->user()]) }}"
